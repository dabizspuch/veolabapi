...
trait OperationInventoryTools
{
    ...
    */
    ...
    /**
     * Recalcula el stock del lote de un producto y genera un movimiento.
     * 
     * @param string $productDelegation - Delegación del producto
     * @param string $productCode - Código del producto
     * @param string $lotNumber - Número de lote
     * @param float $amount - Cantidad a actualizar en el stock
     * @param string $movementType - Tipo de movimiento
     */
    public function recalculateLotStock(
        string $productDelegation, 
        string $productCode, 
        string $lotNumber, 
        float $amount, 
        string $movementType
